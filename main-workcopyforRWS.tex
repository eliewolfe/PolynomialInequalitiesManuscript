...
We now introduce the notion of \tblue{the inflation of a classical causal model}.  We describe what inflation means for the causal structure and the parameters in turn. We will denote by $C'=(G',\mathcal{P'}(G'))$ the inflation of $C=(G,\mathcal{P}(G))$ and we will refer to ...
