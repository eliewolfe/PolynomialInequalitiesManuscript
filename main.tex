...
Since the GHZ-type distribution~\cref{eq:ghzdistribution1} violates both of these inequalities, it cannot even be generated within the Triangle scenario with quantum or general probabilistic states on the hidden nodes, as was also pointed out in~\cite{pusey2014gdag}.
