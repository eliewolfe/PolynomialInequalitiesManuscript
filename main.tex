...
\end{align}
which also simply follows from the existence of a joint distribution of all variables. Again, implicit per \cref{eq:GHZobsinf} is that that the third term vanishes regardless of what the observable distribution might be, purely as a consequence of $A_2 \aindep B_1$ in \cref{fig:TriDagSubA2B1C1}. We therefore derive
