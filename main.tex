...
%\]
\begin{align}
    \namedand{A \eql a, C \eql c} \implies \namedand{A \eql a, B \eql b} \bigvee \namedand{B \eql \n{b}, C \eql c}
\end{align}
...
\[
	\p{a c} \leq \p{a b} + \p{\n{b} c}
\]
which is therefore a necessary condition for the marginal problem to have a solution. Applying this together with the inflation technique to the Triangle scenario results in
\[
	\p[AC]{a c} \leq \p[A]{a}\p[B]{b} + \p[BC]{\n{b} c},
\]
which is equivalent to the inequality in~\cref{eq:polymonogamy}.
...
\begin{equation}
	\label{eq:lhshardy}
	\namedand{A_2 \eql a_2, B_2 \eql b_2, C_2 \eql c_2}
\end{equation}
...
\begin{align}\begin{split}
	\namedand{A_2 \eql a_2, B_2 \eql b_2, C_2 \eql c_2} \Longrightarrow &\namedand{A_1 = \n{a_1}, B_1 \eql \n{b_1}, C_1 \eql \n{c_1}} \bigvee \namedand{A_1 \eql a_1, B_2 \eql b_2, C_2 \eql c_2} \\
		& \bigvee \namedand{A_2 \eql a_2, B_1 \eql b_1, C_2 \eql c_2} \bigvee \namedand{A_2 \eql a_2, B_2 \eql b_2, C_1 \eql c_1}
\end{split}\end{align}
...
\begin{align}
    \p{a_2 b_2 c_2} \leq \p{\n{a_1} \n{b_1} \n{c_1}}+\p{a_1 b_2 c_2}+\p{a_2 b_1 c_2}+\p{a_2 b_2 c_1}
\end{align}
%\[
%	P_{A_2 B_2 C_2}(111) \leq P_{A_1 B_1 C_1}(000) + P_{A_1 B_2 C_2}(111) + P_{A_2 B_1 C_2}(111) + P_{A_2 B_2 C_1}(111).
%\]
Applying this to our inflation DAG of~\cref{fig:Tri222} results again in one of our previous inequalities,~\cref{eq:FritzF3raw}.
