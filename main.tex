...
\hline
Nonlinear satisfiability & Nonlinear programming,\newline polynomial optimization & e.g.~semidefinite Relaxations & Easy \\
\hline
...
\hline
Possibilistic quantifier elimination & Hypergraph transversal problem & & Very easy \\
\hline 
...
The following inequalities for the Triangle scenario have been derived using the linear quantifier elimination method of~\cref{sec:ineqs} using the inflation DAG of~\cref{fig:Tri222}. follow from \cref{fig:Tri222} using linear quantifier elimination. The list is incomplete; longer inequalities have been excised in order to fit the page. A denser but complete list is embedded as the final page of this PDF. All the inequalities below are nontrivial, 
\purp{T: make sure about this!}
