...
For example, suppose that in a scenario where the pairwise joint distributions of three variables $A$, $B$ and $C$ are given.

\begin{itemize}
	\item Classifying Hardy-type paradoxes amounts to enumerating the minimal transervals of a hypergraph, which is computationally relatively tractable.
	\item Every Hardy-type paradox can be turned into an inequality at the level of probabilities.
	\item Many of our inequalities can be obtained in this way.
\end{itemize}
